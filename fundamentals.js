...
let cadena = array1.concat(array2);
console.log(cadena);
...
/*Ejercicio 6
Escribe una función que acepte dos argumentos: el primero será un objeto, el segundo una key. Si el objeto tiene dicha key, deberás borrarla y devolver true; si no, deberás devolver false. Ejemplo:
...
Escribe una función que acepte un hobbie y lo añada a la lista de hobbies de nuestro megaTeacher.
...
Modifica la primera función: debe aceptar un array de nuevos hobbies, y se lo añadirá a los hobbies del objeto hasta que éstos últimos sean 8, no más. Ejemplo:
...
Usando el método de array flat().
Usando reduce().
Bonus 2
Tienes 3 arrays:
